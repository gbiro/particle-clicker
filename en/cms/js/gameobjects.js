...
var GameObjects = (function() {
  ...
  var lab = $.extend({}, labPrototype, ObjectStorage.load('lab_e'));
  ...
  var saveAll = function() {
    ObjectStorage.save('lab_e', lab);
    ObjectStorage.save('research_e', research);
    ObjectStorage.save('workers_e', workers);
    ObjectStorage.save('upgrades_e', upgrades);
    ObjectStorage.save('achievements_e', achievements);
  };
